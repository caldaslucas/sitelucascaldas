			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Lucas Caldas Design</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Lucas Caldas Design</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="http://localhost:10005/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
